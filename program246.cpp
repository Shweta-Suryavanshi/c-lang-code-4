//to convert specific program to generic program we cannot use typedef//generic is reffered to as all datatype 
#include<iostream>
using namespace std;
...
int main()
{
    ...
    fobj.InsertLast(21.67);
    fobj.InsertLast(31.56);
    fobj.InsertLast(41.56);

    cout<<"Linkedlist of flots : "<<"\n\n";
    fobj.Display();

    dobj.InsertLast(11.999);
    dobj.InsertLast(21.9999);
    dobj.InsertLast(31.999999);
    dobj.InsertLast(41.99999);
